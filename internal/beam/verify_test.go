...
func TestDeflectionMagnitudeMatchesMomentEnvelope(t *testing.T) {
	...
	// at a smooth point away from the load, y'' = -M/EI for the reported
	// (downward-positive) deflection; finite-difference the samples.
...
func TestRefinedMomentExtremaInteriorTurningPoint(t *testing.T) {
	...
	// the exact M peak of the segmented load sits at x=5.2667, between knots
